...
func (p *SeasonalEffectsPlugin) Phase() Phase {
	return PhasePostProcess
}

func (p *SeasonalEffectsPlugin) Requires() []string {
	return nil
}

func (p *SeasonalEffectsPlugin) AdminPolicy() AdminPolicy {
	return AdminRun
}

func (p *SeasonalEffectsPlugin) Execute(ssg *models.SSG) error {
	config := &ssg.Config
...
func init() {
	RegisterPlugin("SeasonalEffects", func() Plugin {
		return &SeasonalEffectsPlugin{PluginName: "SeasonalEffects"}
	})
}
