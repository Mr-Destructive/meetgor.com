...
long_description: I have talked about Vim  Vim buffers are the chunks of memory that
  ...
  within Vim. So
now: 2022-07-24 13:37:38.455691
...
<div class='prevnext'>
    ...
    <a class='prev' href='/django-database-conf'>
    ...
    <a class='next' href='/vim-plus-teminal'>
    
        <div class='prevnext-text'>
            <p class='prevnext-subtitle'>next</p>
            <p class='prevnext-title'>Vim: Terminal Integration</p>
        </div>
        <svg width="50px" height="50px" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
