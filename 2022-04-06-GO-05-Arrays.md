...
long_description: In this fifth section of Golang, we will be understanding the basics
  ...
  structure that a
now: 2022-07-24 13:37:38.456600
...
<div class='prevnext'>
    ...
    <a class='next' href='/django-basics-views-urls'>
    
        <div class='prevnext-text'>
            <p class='prevnext-subtitle'>next</p>
            <p class='prevnext-title'>Django Basics: Views and URLS</p>
        </div>
        <svg width="50px" height="50px" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
