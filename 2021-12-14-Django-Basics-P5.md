...
now: 2022-07-24 13:37:38.450666
...
<div class='prevnext'>
    ...
    <a class='prev' href='/django-basics-intro'>
    ...
    <a class='next' href='/django-deploy-railway'>
    
        <div class='prevnext-text'>
            <p class='prevnext-subtitle'>next</p>
            <p class='prevnext-title'>Django Project with PostgreSQL Deployment on Railway App</p>
        </div>
        <svg width="50px" height="50px" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
