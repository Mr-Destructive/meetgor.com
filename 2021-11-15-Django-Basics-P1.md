...
long_description: 'Welcome to Django Basics series, in this series we Django is an
  ...
  lets you store '
now: 2022-07-24 13:37:38.450861
...
<div class='prevnext'>
    ...
    <a class='prev' href='/django-basics-static-files'>
        ...
        <div class='prevnext-text'>
            ...
            <p class='prevnext-title'>Django Basics: Static Files</p>
        </div>
    </a>
    
    <a class='next' href='/django-basics-templates'>
    
        <div class='prevnext-text'>
            <p class='prevnext-subtitle'>next</p>
            <p class='prevnext-title'>Django Basics: Templates</p>
        </div>
        <svg width="50px" height="50px" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
