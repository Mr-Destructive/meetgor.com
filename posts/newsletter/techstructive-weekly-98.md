...
> 
> — [Haruki Murakami, Kafka on the Shore](https://www.goodreads.com/quotes/435053-the-journey-i-m-taking-is-inside-me-just-like-blood)
...
- APIs: [apis.meetgor.com](https://apis.meetgor.com/docs)
...
1. [belderbos.dev: “Rust Is for People Who Want to Be Punished.” Now Jochen Trusts It More Than Python](https://belderbos.dev/blog/jochen-rust-cohort-beat-cpython/)
   ...
   3. I like the author’s honesty and raw expression but I am not in a right mindset to agree to this I think, we are past the point where programming languages matter in making code look readable.
2. Sean Goedecke’s blog: [Doing nothing at work](https://www.seangoedecke.com/doing-nothing-at-work/)
   
   1. This is a good post, there are stressful times in a year mostly two or three, but month after month is not sustainable right?
   2. I thought working at a startup might be good for learning, but its turning out to be a double edged sword of stress and no time to breathe. Its too much of cognition overload, with AI its becoming a nightmare to get up daily and grind 12 hours.
   3. But the points here are laid out really well. You need to be unoccupied in order to do a high impact task, and also doing the right thing at the right time, that only happens if your mind is clear.
3. [API Evangelist: Replacing the Petstore OpenAPI with the Train Travel OpenAPI Specs](https://apievangelist.com/2024/07/01/replacing-the-petstore-with-the-train-travel-openapi/): [https://bump.sh/blog/modern-openapi-petstore-replacement](https://bump.sh/blog/modern-openapi-petstore-replacement)
   
   1. This is a fresh take on use dummy api examples vs serious examples correctly.
   2. I like good examples, it helps go beyond the basics and enforce certain good practices is a bonus.Going beyond CRUD is what makes this likable and relatable.
   3. It is common enough and specific enough to make the reader and the learner distinguish his / her perspective and take away all the good lessons.
4. [Zed Blog: Software is made between commits](https://zed.dev/blog/introducing-deltadb)
   
   1. Really interesting. I agree that the meat of the decisions happen before even a commit is made, the commit might be a lossy compression of the decisions and features scopes.
   2. With delta db it looks something different, I am not sure what the flow would be, but having all the context and history of what happened to the code as it got transformed from one stage to other is really correct analogy. Especially after agentic engineering is taking off.
   3. I haven’t tried Zed, maybe this month might be a good one to do so, who knows there’s a world beyond vim?
5. [AI as Normal Tech: Why AI hasn’t replaced software engineers and won’t](https://www.normaltech.ai/p/why-ai-hasnt-replaced-software-engineers)
   
   1. The sandwich of decide-execution-deliver is really a good analogy. I also agree to the two opposite ends are not replacable by AI at all, that is a human part, that is something humans have to do.
   2. Execution is largely solved is like saying “Coding is mostly solved” that might not be entirely true but yes, generating a code is solved, what and why that question is not.
   3. A really good hopeful post in a age of slop and fear.

## Watched

- [What’s new in OpenAPI 3.2 by Lorna Mitchel Jane](https://youtu.be/0jAGXY6zjss)
...
- [It finally happened, DHH’s take is wrong maybe](https://youtu.be/pkndFYSTr0Y)
...
- [The Primeagen takes on “Coding is solved”: I think they are lying to you](https://youtu.be/zfYsSFY4l18)
...
- [Anthropic releases Fable 5 (Nerfed Mythos)](https://www.anthropic.com/news/claude-fable-5-mythos-5)
...
- [OpenCV 5 Released](https://opencv.org/opencv-5/)
...
For more news, follow the [Hackernewsletter](https://buttondown.com/hacker-newsletter/archive/797) (#797th edition), and for software development/coding articles, join daily.dev.
