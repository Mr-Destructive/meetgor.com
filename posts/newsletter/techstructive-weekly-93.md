...
> — [Rumi](https://www.goodreads.com/quotes/6822193-the-quieter-you-become-the-more-you-are-able-to)
...
1. [Vibe coding and agentic engineering are getting closer more than I had like](https://simonwillison.net/2026/May/6/vibe-coding-and-agentic-engineering/)
...
2. [We programmed a program to program new programs (2011)](https://smbc-comics.com/comic/2011-09-08)
...
- [Andrej Karapathy: From Vibe Coding to Agentic Engineering](https://youtu.be/96jN2OCOfLs)
...
- [What’s Next for Software Tracking and Git?](https://youtu.be/HuE7OvOckfE)
...
- [DHH’s new way of writing code](https://youtu.be/JiWgKRgdgpI)
...
- [Why AI Agents are tither the best or worst thing we’ve built](https://youtu.be/WnzR5aOElvw)
...
- [Am I Crazy?](https://youtu.be/Sp1EmFRDquA) Wading Through AI Episode 3
...
- [Volatile keyword in Java](https://youtu.be/yg_UPwSD3-U)
...
- Software can be made easily now, but that doesn’t mean people want to right?
  ...
  - Like the analogy from [Simon Wilison on](https://simonwillison.net/2026/May/6/vibe-coding-and-agentic-engineering/#:~:text=I%20can%20plumb%20my%20house%20if%20I%20watch%20enough%20YouTube%20videos%20on%20plumbing.%20I%20would%20rather%20hire%20a%20plumber) plumbing. You can learn how to plumb your house with youtube or learn to code by AI, write that software vibe coded. But if its really important to you, and don’t want any issues, you probably want to hire a plmber or a developer right?
...
- [AI Map](https://vivamau.github.io/aimap/)

## Tech News

- [Anthropic is no more Misanthropic, shakes hands with XAI/SpaceX, whatever](https://www.anthropic.com/news/higher-limits-spacex)
  
  - Yep, that explains this. Our enemies’s enemy is friend of mine. Anthropic and XAI have joined hands against OpenAI. This is AI Cold Wars.
- [Cloudflare to lay off 20% of workforce](https://www.reuters.com/business/world-at-work/cloudflare-cut-over-1100-jobs-2026-05-07/), after Coinbase does 14%
  
  - Oh! This is another one. Not sure AI is the reason or is that a excuse for over hiring in the COVID era.
  - Whatever that might be, the term job security is a myth these days. There is no such thing.
- [OpenAI releases 5.5 Instant](https://openai.com/index/gpt-5-5-instant/)
  
  - This looks like a flash model from OpenAI. If it was for free on the API, these might be my go to one. Haiku is expensive.

For more news, follow the [Hackernewsletter](https://buttondown.com/hacker-newsletter/archive/793) (#793rd edition), and for software development/coding articles, join daily.dev.

* * *

That was it from the week 93. Time flies…
