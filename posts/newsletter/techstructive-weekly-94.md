...
1. [From today software engineering is dead](https://building138.com/from-today-software-engineering-is-dead)
   
   1. Feels good to read this. Gives kind of a good satisfaction that it will still be there. Just like photography.
   2. I agree it will become more accessible that is the part I am happy about because people would develop empathy for every developer. Its not easy to build good software will eventually be realised to them.
2. [God, AI is making me dumb](https://jpain.io/god-damn-ai-is-making-me-dumb/)
   
   1. This is an AI psychosis moment for all of us, perhaps a wake up call?
   2. Being mindful about doin anything hasn't been so valuable ever. Delegating is so easy now, only if you know when to take the control back. Else you might be an autopilot.
3. [I am going back to writing code by hand, please read](https://blog.k10s.dev/im-going-back-to-writing-code-by-hand/)the full article
   
   1. This is a hilarious article. For one it just is amazing how a person can work on a side project for 30 weeks.
   2. Second its hard to relate because models keep changing and every model starts doing its own style, it becomes a saphegetti of code. So I dont know it can be compared to writing code by hand.
   3. But the only part that is worth noting is the taking control of the structure of code, that is worth learning else you might doom yourself.

## Watched

- [React from scratch](https://youtu.be/s0cxhde2zvY?si=5A-zIZjUk9HoMNeC)
  
  - Wow, that was really cool. The level of questions one asks before learning something is so underrated.
...
- [Creator of SQLite on AI, Turso and 26 years of code](https://youtu.be/x8_ZZhRL3YU?si=dDC3Gmrg0hv4ORkY)
...
- [We all fell for agentic coding](https://youtu.be/lNVa33qUzZ8?si=WoXtnbzcCJjoYue5)
...
- [I don't like programming: clickbait](https://youtu.be/jdJ5jg0XSmU?si=uJv2DMjoQUm1fCE-)
...
- [Grok Build](https://x.ai/news/grok-build-cli): Still code is the moat for unused GPUs?
...
Thats it from this long week, wrecked my back. Learning is something I am getting back into, its getting harder and harder to get back it seems but the more further we go, the harder its going to get.
