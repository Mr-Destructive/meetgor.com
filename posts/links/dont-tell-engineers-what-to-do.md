...
date: 2025-08-09
slug: dont-tell-engineers-what-to-do
tags:
  - links
link: 'https://code.dblock.org/2025/07/30/dont-tell-engineers-what-to-do.html'
status: published
description: 'Don’t tell engineers what to do?'
image_url: 'https://code.dblock.org/images/default-thumb.png'
source: newsletter
...
- Everything in the post that has been said, is totally relatable and worth reading for me. I read and felt a deep satisfaction that I might be just right and move on with the things.
